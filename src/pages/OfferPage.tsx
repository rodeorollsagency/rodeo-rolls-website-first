...
const offerCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      "Teledyski, dokumenty, reportaże, Filmy promocyjne i reklamowe",
  ...
  },
  {
    ...
    items: [
      "Projektowanie logo (unikalne znaki graficzne budujące wizerunek marki)",
...
const OfferPage = () => {
  return (
    <div className="min-h-screen bg-gray-950 text-foreground"> {/* Using a deeper black for the page background */}
      <Navbar />
      <section id="offer-page" className="py-20 pt-32"> {/* Added pt-32 to account for fixed navbar */}
